...
import { LayoutService } from '../general/service/app.layout.service';
...
export class ManagerComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.manager.role = localStorage.getItem('role');
    // if (this.manager.token != '' && this.manager.role != 'Emploie') {
